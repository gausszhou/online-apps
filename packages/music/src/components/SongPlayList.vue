<template>
  <div class="song-playlist">
    <div class="song-playlist-mask" @click.self.stop="close"></div>
    ...
    <ul class="song-playlist-body">
      ...
      >
        ...
        <a
          ...
          :class="index === songIndex && songIsPlay ? 'icon-pause-mobile' : 'icon-play-mobile'"
          @click="getMusic(item, index)"
        ></a>
      </li>
    </ul>
    <div class="song-playlist-footer-mask"></div>
    </div>
  </div>
</template>
